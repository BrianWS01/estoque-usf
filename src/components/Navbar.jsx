...
import { ShieldCheck, User, ShieldAlert, RotateCcw, Award, LogOut } from 'lucide-react';

export const Navbar = () => {
  const { currentUser, switchProfile, resetarDados, isAuthenticated, logout } = useAuth();
    ...
    <header className="navbar">
      ...
      {isAuthenticated && currentUser && (
        <>
          ...
          {/* Usuário Atual, Reset e Sair */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <div style={{ textAlign: 'right' }} className="user-badge-desktop">
